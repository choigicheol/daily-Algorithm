...
function solution(n) {
    var answer = [];
    // n = 1일 때
    // start = 1번기둥, end = 3번기둥으로 1개를 옮긴다.

    // n = 2일 때
    // start = 1번기둥, end = 2번 기둥으로 n-1개의 원판을 옮긴다
    // 마지막 원판을 3번 기둥으로 옮긴 후
    // start = 2번기둥, end = 3번 기둥으로 n-1개의 원판을 옮긴다.

    // n = 3일 때
    // start = 1번기둥, end = 2번기둥으로 n-1개의 원판을 옮긴다
    // 마지막 원판을 3번 기둥으로 옮긴 후
    // start = 2번기둥, end = 3번기둥으로 n-1개의 원판을 옮긴다.
    ...
    // 현재원판이 꽂혀있는 기둥과 옮겨야하는 목표 기둥에 따라 경유가 달라진다.
